...
const DeleteProductPage = () => {
  ...
  return (
    <>
      <div className='max-w-[400px] mx-auto shadow-[1px_3px_18px_#ccc] rounded-2xl p-5 mt-5'>
        ...
        <div className=''>
          ...
          <div className='flex justify-center mt-5'>
            <button
              onClick={goBack}
              className='w-100px btn btn-outline btn-primary mx-5'
              disabled={loading}
            >
              go back
            </button>
            <button
              ...
              className='w-100px btn btn-outline btn-secondary mx-5'
              disabled={loading}
            >
